		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<div class = "inference">
					...
					<!-- <p class = "infd"><li class = "infd">Based on the given data, it can be inferred that IIT Bombay, IIT Delhi, IIT Kanpur, IIT Kharagpur, IIT Roorkee, IIT Madras, and IIT Hyderabad are some of the most popular choices among top performers in various categories in the JEE examination.</li><br> -->
