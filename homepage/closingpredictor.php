	...
	<div class = "DIV4">
		...
		<div class = "DIV3">
			<form action="" method="post" class="form"> 
				...
				<option value="AEAerospace Engineering (5 Years, Bachelor and Masters of Technology)5">Aerospace Engineering (5 Years, Bachelor and Masters of Technology)</option>
